...
namespace Capstone
{
    class SalesReport
    {
        ...
        {
            TotalSalesByItemName = CreateSalesDictionary(ItemBySlotLocation);
            SalesReportWriter(TotalSalesByItemName);
        }

        public Dictionary<string, int> TotalSalesByItemName { get; }

        public Dictionary<string, int> CreateSalesDictionary(Dictionary<string, Item> ItemBySlotLocation) //Creating dictionary based on Master ItemBySlotLocation
        {
