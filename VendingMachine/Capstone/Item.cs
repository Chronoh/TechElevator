...
namespace Capstone
{
    public class Item
    {
        ...
        public string Type { get; private set; } // consider subclass based on type w/ abstract use of item class
        public string Quantity { get; private set; }  //setting type to string so that Quantity == 0 --> string "SOLD OUT"
        //public string Quantity { get; private set; }  //use the string prop to be used as the 'displayed' qty. use an INT prop for the actual qty.
